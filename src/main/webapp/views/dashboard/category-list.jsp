                                                            ...
                                                            <td>
                                                                <c:choose>
                                                                    <c:when test="${c.status == 1}">
                                                                        <span
                                                                            class="badge-status badge-active">Active</span>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <span
                                                            ...
                                                            <c:choose>
                                                                ...
                                                                '${c.status}'
                                                                                            ...
                                                                                            <button type="button"
                                                                                                ...
                                                                                                title="Edit" onclick="openEditPopup(
                                        <button type=" button" class="btn-action btn-edit" title="Edit" onclick="openEditPopup(
                                                                '${c.categoryId}',
                                                                '${c.categoryName}',
                                                                '${c.descriptionText}',
                                                                '${c.status}',
                                                            ...
                                                            <c:if test="${not empty deleteError}">
                                                                <div class="alert alert-danger mt-3 ">${deleteError}
                                                                </div>
                                        ...
                                        <form action="${pageContext.request.contextPath}/category" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="status" class="form-control">
                                                    <option value="1" ${createStatus==1 ? "selected" : "" }>Active
                                                    </option>
                                                    <option value="0" ${createStatus==0 ? "selected" : "" }>Inactive
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="parent" class="form-control">
                                                    ...
                                                    <option value="1" ${createParent==1 ? "selected" : "" }>Book
                                                    </option>
                                                    <option value="2" ${createParent==2 ? "selected" : "" }>Văn phòng
                                                        phẩm</option>
                                                </select>
                                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div id="detailPopup" class="modal-overlay">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn-cancel"
                                            onclick="closeDetailPopup()">Close</button>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                            ...
                            <div id="editPopup" class="modal-overlay">
                                <div class="modal-content ">
                                    ...
                                    <c:if test="${not empty editError}">
                                        <div class="alert alert-danger p-2 mb-3 alert-error" id="editErrorMsg"
                                    ...
                                    <form action="${pageContext.request.contextPath}/category" method="post">
                                        ...
                                        <form action="${pageContext.request.contextPath}/category" method="post">
                                            ...
                                            <div class="form-group">
                                                <label>Description</label>
                                                <input type="text" name="descriptionText" id="editDescription"
                                                    class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label>Description</label>
