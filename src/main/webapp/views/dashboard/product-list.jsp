                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <form action="${pageContext.request.contextPath}/dashboard/product"
...
<div id="addPopup" class="modal-overlay" style="display: ${openCreateModal ? 'flex' : 'none'};">
    <div class="modal-content" style="width: 700px; max-width: 90%; max-height: 90vh; overflow-y: auto;">
        ...
        <form id="createForm" action="${pageContext.request.contextPath}/dashboard/product" method="post" enctype="multipart/form-data">
...
<c:if test="${not empty productEdit}">
    <div id="editPopup" class="modal-overlay" style="display: flex;">
        <div class="modal-content" style="width: 700px; max-width: 90%; max-height: 90vh; overflow-y: auto;">
            ...
            <form action="${pageContext.request.contextPath}/dashboard/product" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <a href="${pageContext.request.contextPath}/dashboard/product?tab=${currentTab}" class="btn-cancel" style="text-decoration:none;">Cancel</a>
