    ...
    <div class="modal-content">
        ...
        <form action="staff" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" id="editStaffFullName" name="fullName" class="form-control" placeholder="Enter full name" required>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="password" id="editStaffPassword" name="password" class="form-control" placeholder="Enter new password (optional)">
            </div>
