        ...
        <c:if test="${totalPages > 1}">
            <div class="pagination">
                ...
                <c:if test="${currentPage > 1}">
                    <a href="${pageContext.request.contextPath}/dashboard/customer?page=${currentPage - 1}" 
                       class="page-btn">«</a>
                </c:if>

                <!-- Page 1 -->
                <a href="${pageContext.request.contextPath}/dashboard/customer?page=1"
                ...
                <c:if test="${currentPage != 1 && currentPage != totalPages}">
                    <a href="${pageContext.request.contextPath}/dashboard/customer?page=${currentPage}"
                ...
                <!-- Last page -->
                <c:if test="${totalPages > 1}">
                    <a href="${pageContext.request.contextPath}/dashboard/customer?page=${totalPages}"
