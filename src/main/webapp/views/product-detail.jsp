                        ...
                        <div class="action-area">
                            <form action="cart" method="post">
                                ...
                                <input type="number" id="quantity" name="quantity" class="qty-input" value="1" min="1"
                                    max="${p.stockQuantity}" required ${p.stockQuantity <=0 ? 'disabled' : '' } />

                                <br><br>

                                <button type="submit" name="action" value="add" class="btn btn-cart" ${p.stockQuantity
                                    <=0 ? 'disabled' : '' }>
                                    <i class="fa fa-shopping-cart"></i> Add to Cart
                                </button>

                                <button type="submit" name="action" value="buy" class="btn btn-buy" ${p.stockQuantity
                                    <=0 ? 'disabled' : '' }>
                                    Buy Now
                                </button>
                            </form>
